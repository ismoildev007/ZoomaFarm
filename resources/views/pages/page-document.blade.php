                            ...
                            <div class="tb-GridColumn tb-GridColumn--l--20 tb-GridColumn--offset--l--2">
                                <div class="top-info m-s-bottom tb-Grid tb-Grid--l--20 tb-Grid--m--20 tb-Grid--s--20 tb-Grid--xs--20">
                                    <div class="tb-GridColumn tb-GridColumn--l--13 tb-GridColumn--m--16 tb-GridColumn--s--20 tb-GridColumn--offset--l--0">
                                        <h1 class="h1-s m-xxs-bottom">
                                            @if($lang === 'uz') Sertifikatlar
                                            @elseif($lang === 'ru')Сертификаты
                                            @else
                                                Certificates
                                            @endif
                                         </h1>
                                    ...
                                    <div class="tb-GridColumn tb-GridColumn--l--10 tb-GridColumn--s--16 tb-GridColumn--xs--20 tb-GridColumn--offset--l--0">
                                        <div class="tb-GridColumn tb-GridColumn--l--13 tb-GridColumn--s--20 tb-GridColumn--offset--l--0">
                                            <div class="leadtext description richtext color-white">
                                                @if($lang === 'uz') Bizning sertifikatlarimiz sizning malakangiz va bilimlaringizni tasdiqlaydi. Ular xalqaro standartlarga mos kelib, professional rivojlanishingizga yordam beradi.
                                                @elseif($lang === 'ru')Наши сертификаты подтверждают ваши навыки и знания. Они соответствуют международным стандартам и помогают вашему профессиональному развитию.
                                                @else
                                                    Our certificates validate your skills and knowledge. They comply with international standards and support your professional growth.
                                                @endif
                                                <br />
                                            </div>
                                        </div>
                                                                ...
                                                                <a href="{{ route('single.document', $document->id) }}" aria-label="{{ $document->{'name_' . $lang} }}">
                                                                    <div class="image-video-wrapper">
                                                                        <div class="image-video-content-wrapper m-xs-bottom">
                                                                            <picture>
                                                                                <img src="{{ asset('storage/' . $document['image_' . $lang]) }}"
                                                                                    alt="{{ $document->{'name_' . $lang} }}"
                                                                                    loading="eager" />
                                                                            </picture>
                                                                        </div>
                                                                        @php
                                                                        ...
                                                                        <div class="right-arrow-animation">
                                                                            ...
                                                                            <div class="link m-xs-top">
                                                                                <a href="{{ route('single.document', $document->id) }}" target="_self"
