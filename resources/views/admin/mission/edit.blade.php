...
@section('content')
    <form action="{{ route('missions.update', $mission->id) }}" method="POST" enctype="multipart/form-data" novalidate class="needs-validation" onsubmit="updateEditorContent()">
        @csrf
        @method('PUT')
                                    ...
                                    <div class="tab-content pt-3">
                                        <div class="tab-pane fade show active" id="uzContent">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="title_uz" name="title_uz" value="{{ old('title_uz', $mission->title_uz) }}" required>
                                            </div>

                                            <div class="form-group pb-3">
                                                <label for="description_uz">Контент (UZ):</label>
                                                <div id="editor_uz" style="height:400px;">{!! old('description_uz', $mission->description_uz) !!}</div>
                                        ...
                                        <div class="tab-pane fade" id="enContent">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="title_en" name="title_en" value="{{ old('title_en', $mission->title_en) }}" required>
                                            </div>

                                            <div class="form-group pb-3">
                                                <label for="description_en">Контент (EN):</label>
                                                <div id="editor_en" style="height:400px;">{!! old('description_en', $mission->description_en) !!}</div>
                                        ...
                                        <div class="tab-pane fade" id="ruContent">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{ old('title_ru', $mission->title_ru) }}" required>
                                            </div>

                                            <div class="form-group pb-3">
                                                <label for="description_ru">Контент (RU):</label>
                                                <div id="editor_ru" style="height:400px;">{!! old('description_ru', $mission->description_ru) !!}</div>
                            ...
                            <div class="card stretch">
                                ...
                                <div class="card-body p-4">
                                    <div class="form-group pb-3">
                                        ...
                                        @if($mission->image)
                                            <div class="mt-3">
                                                <img src="{{ asset('storage/' . $mission->image) }}" alt="Current Image" style="width: 100%; max-height: 300px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
        ...
        <script>
            ...
            editorUz.root.innerHTML = `{!! old('description_uz', $mission->description_uz) !!}`;
            editorEn.root.innerHTML = `{!! old('description_en', $mission->description_en) !!}`;
            editorRu.root.innerHTML = `{!! old('description_ru', $mission->description_ru) !!}`;
