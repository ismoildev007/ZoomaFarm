...
@section('title', 'Список Документы')
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Список Документы</h5>
                    </div>
                    <ul class="breadcrumb">
                            ...
                            <div class="card-body p-0">
                                <div class="px-2 py-3">
                                    <div class="d-flex justify-content-between">
                                        <h4 class="bold">Документы</h4>
                                        <div class="">
                                            <div class="dataTables_filter">
                                                <a href="{{ route('documents.create') }}" class="btn btn-sm btn-primary">Добавить</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a href="{{ route('documents.show', $partner->id) }}" class="avatar-text avatar-md d-none">
                                                            <i class="feather feather-eye"></i>
                                                        </a>
                                                        <a href="{{ route('documents.edit', $partner->id) }}" class="avatar-text avatar-md">
                                                            <i class="feather feather-edit-3"></i>
                                                        </a>
                                                        <form action="{{ route('documents.destroy', $partner->id) }}" method="POST" style="display: inline-block;">
                                                            @csrf
                                                            @method('DELETE')
